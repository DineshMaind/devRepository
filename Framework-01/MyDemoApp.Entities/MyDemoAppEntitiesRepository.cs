...
{
    public partial class MyDemoAppEntities : IRepository
    {
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        public TEntity Add<TEntity>(TEntity entity) where TEntity : class
        {
            base.Entry<TEntity>(entity).State = System.Data.Entity.EntityState.Added;
            return entity;
        }
        ...
        {
            base.Entry<TEntity>(entity).State = System.Data.Entity.EntityState.Deleted;
            return entity;
        }
